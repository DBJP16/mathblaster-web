...
let score = 0, lives = 3, gameOver = false, question = null, gameStarted = false, playerName = null;
...
function create() {
    ...
    this.input.keyboard.on('keydown-SPACE', () => {
        ...
        if (gameStarted && !gameOver && bullets.getLength() < 20) {
            ...
            console.log("Cannot shoot: gameStarted=", gameStarted, "gameOver=", gameOver, "bullets count=", bullets.getLength());
        }
    });
