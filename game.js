...
let player, bullets, answerShips, questionText, scoreText, livesText, instrText, playerName = "";
    ...
    this.input.keyboard.on('keydown-SPACE', () => {
        ...
        if (gameStarted && !gameOver && bullets.getLength() < 20) {
            ...
            if (bullet) {
                ...
                console.log("Bullet created at", player.x, player.y - 10);
            } else {
...
// Answer ship
class AnswerShip extends Phaser.GameObjects.Rectangle {
    constructor(scene, x, number) {
        super(scene, x, 50, 50, 50, 0xFF0000); // Simple red square
    ...
    update() {
        // No shooting yet—keep it simple
    }
...
function startGame(scene) {
    ...
    player = scene.add.rectangle(400, 540, 50, 50, 0xFFFF00); // Simple yellow square
